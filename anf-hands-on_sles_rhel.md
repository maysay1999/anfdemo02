# Azure NetApp Files ハンズオン NFS 編 SLES or RHEL
...
* AzACSnap(Azure Application Consistent Snapshot tool) については[こちら](https://docs.microsoft.com/ja-jp/azure/azure-netapp-files/azacsnap-get-started)をご参照下さい
...
* RHELのパラメータ
  * Virtual machine name: **redhat1**
  * Region: **Japan East**
  * Image: **Red Hat Enterprise Linux 8.1**
  * VM type: **Standard_D2s_v4**
  * Authentication type: **Password**
  * Username: **anfadmin**
  * Password: ---- (min length is 12)
